      ...
      <main className="tt-main">
        <div className="tt-breadcrumb">
          <Link href="/buyer/messages">
            <span className="material-icons" style={{ fontSize: 16 }}>arrow_back</span> Back to Messages
          </Link>
          <span>/</span>
        ...
        <div className="tt-header">
          ...
          <div className="tt-status-pill">
            {t.status === "completed" ? "Completed" : t.status === "cancelled" ? "Cancelled" : "In Progress"}
          </div>
        </div>
        ...
        <div className="tt-layout">
          <div>
            <div className="tt-card">
              <div className="tt-card-head">
                ...
                <span className="tt-percent">{t.progress_percent}%</span>
              </div>
              <div className="tt-rail"><div className="tt-fill" style={{ width: `${t.progress_percent}%` }} /></div>
              <div className="tt-step-current">Step {t.step_current} of {t.step_total} — {STEPS[currentIdx].label}</div>
                  ...
                  return (
                    <li key={s.key} className={`tt-step tt-${state}`}>
                      <div className="tt-step-icon">
                        <span className="material-icons">{state === "done" ? "check" : s.icon}</span>
                      </div>
          ...
          <aside className="tt-side">
            ...
            <div className="tt-prop-card">
              <div className="tt-label">Need Help?</div>
              ...
              <button className="tt-btn-outline" style={{ marginTop: 12 }}>
                <span className="material-icons" style={{ fontSize: 18 }}>support_agent</span> Contact Support
              </button>
            </div>
          </aside>
        </div>
