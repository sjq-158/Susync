...
function EyeOff() {
  return <span className="material-icons" style={{ fontSize: 18 }}>visibility_off</span>;
}

function Eye() {
  return <span className="material-icons" style={{ fontSize: 18 }}>visibility</span>;
}
    ...
    <>
      ...
      <Link href="/" className="logo-head">
        <div className="logo-box">
          <svg width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="3"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"></path></svg>
        </div>
      ...
      <div className="auth-card">
        ...
        {error && (
          <div className="error-banner">
            <span className="material-icons" style={{ fontSize: 16, flexShrink: 0 }}>error</span>
            {error}
          </div>
        )}
          ...
          <div className="demo-pills">
            {DEMO_USERS.map((u) => (
              <button
                ...
                onClick={() => fillDemo(u)}
              >
                <span className="material-icons" style={{ fontSize: 14, verticalAlign: "middle" }}>{u.role === "buyer" ? "person" : "home"}</span> {u.email.split("@")[0]}
              </button>
            ))}
          </div>
        </div>
      ...
      <div className="trust-row">
        <div className="trust-item"><span className="material-icons" style={{ fontSize: 14 }}>lock</span> 256-bit SSL</div>
        <div className="trust-item"><span className="material-icons" style={{ fontSize: 14 }}>shield</span> DICT Compliant</div>
        <div className="trust-item"><span className="material-icons" style={{ fontSize: 14 }}>verified</span> Secure Platform</div>
      </div>
    </>
  );
}