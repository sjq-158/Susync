...
function Check() {
  return <span className="material-icons" style={{ fontSize: 14, color: "white" }}>check</span>;
}
  ...
  return (
    <>
      ...
      <div className="trust-badges">
        <div className="badge"><span className="material-icons" style={{ fontSize: 14 }}>lock</span> 256-bit SSL</div>
        <div className="badge"><span className="material-icons" style={{ fontSize: 14 }}>shield</span> DICT Compliant</div>
        <div className="badge"><span className="material-icons" style={{ fontSize: 14 }}>verified</span> Secure Platform</div>
      </div>
    </>
  );
}